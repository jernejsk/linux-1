 ...
 * otherwise undocumented 0x4100 block come from there and from the H3/H5 TV
 * encoder register layout in U-Boot.
 */
...
#define AC200_TVE_MOD1_UNKNOWN		BIT(2)
#define AC200_TVE_MOD1_YC_EN		BIT(1)
#define AC200_TVE_MOD1_COMP_EN		BIT(0)
#define AC200_TVE_DAC_CFG0		0x4008
/*
 * Bit 12 is set while the plug detector runs and cleared to drive video, so
 * it selects between the two detection regimes described in the datasheet.
 * The remaining set bits are undocumented DAC bias settings.
 */
#define AC200_TVE_DAC_CFG0_BIAS		0x02a0
#define AC200_TVE_DAC_CFG0_DETECT_MOD	BIT(12)
...
#define AC200_TVE_UNKNOWN_18		0x4018
#define AC200_TVE_UNKNOWN_1A		0x401a
...
/* these line up with the H3 resync register, but not with the values it takes */
#define AC200_TVE_RESYNC0		0x4130
#define AC200_TVE_RESYNC1		0x4132
/*
...
static const struct reg_sequence ac200_tve_ntsc_regs[] = {
	...
	{ AC200_TVE_UNKNOWN_18,           0x0016 },
	{ AC200_TVE_UNKNOWN_1A,           0x0000 },
	{ AC200_TVE_TOTAL_LINE,           525 },	/* see note below */
	{ AC200_TVE_FIRST_ACTIVE,         22 },
	{ AC200_TVE_BLACK_LEVEL,          282 },
	{ AC200_TVE_BLANK_LEVEL,          240 },
	{ AC200_TVE_COLOR_BURST,          0x0001 },
	{ AC200_TVE_COLOR_BURST + 2,      0x0000 },
	{ AC200_TVE_VSYNC_NUM,            0x0000 },
	...
	{ AC200_TVE_BURST_PHASE,          0x0000 },
	{ AC200_TVE_BURST_PHASE + 2,      0x0000 },
	...
	{ AC200_TVE_WHITE_LEVEL,          0x0320 },
	{ AC200_TVE_WHITE_LEVEL + 2,      0x01e8 },
	{ AC200_TVE_ACTIVE_NUM,           1440 },
	{ AC200_TVE_ACTIVE_NUM + 2,       0x0000 },
	{ AC200_TVE_CHROMA_BW_GAIN,       0x0000 },
	{ AC200_TVE_CHROMA_BW_GAIN + 2,   0x0001 },
	{ AC200_TVE_NOTCH_WIDTH,          0x0101 },
	...
	{ AC200_TVE_RESYNC0,              0x0000 },
	{ AC200_TVE_RESYNC1,              0x2004 },
};
...
static const struct reg_sequence ac200_tve_pal_regs[] = {
	...
	{ AC200_TVE_COLOR_BURST,          0x0000 },
	{ AC200_TVE_COLOR_BURST + 2,      0x0000 },
	{ AC200_TVE_VSYNC_NUM,            0x0001 },
	{ AC200_TVE_VSYNC_NUM + 2,        0x0000 },
	...
	{ AC200_TVE_RESYNC0,              0x0380 },
	{ AC200_TVE_RESYNC1,              0x2009 },
};
