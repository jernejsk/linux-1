 ...
 *
 * Support for the RTL8188E chip, used by the RTL8189ES SDIO module.
 * Derived from the vendor driver (rtl8189ES_linux, master branch,
 * hal/rtl8188e and hal/phydm/{,halrf/}rtl8188e) with rtw8703b.c
...
#include "tx.h"
#include "rtw8188e.h"
#include "rtw8188e_table.h"

static_assert(sizeof(struct rtw8188e_tx_desc) == 32);
static_assert(sizeof(struct rtw8188e_rx_desc) == 24);
static_assert(offsetof(struct rtw8188e_efuse, channel_plan) == 0xb8);
static_assert(offsetof(struct rtw8188e_efuse, rfe_option) == 0xca);
static_assert(offsetof(struct rtw8188e_efuse, mac_addr) == 0x11a);
static_assert(sizeof(struct rtw8188e_efuse) == 0x120);

#define BIT_EN_AMPDU_RTY_NEW BIT(7)
 ...
 * rtw8814a.c). rtw8188e_read_efuse() forces efuse->btcoex to false.
 */
static const u8 wl_rssi_step_8188e[] = {60, 50, 44, 30};
static const u8 bt_rssi_step_8188e[] = {30, 30, 30, 30};
static const struct coex_5g_afh_map afh_5g_8188e[] = { {0, 0, 0} };

static const struct coex_rf_para rf_para_tx_8188e[] = {
...
static const struct coex_rf_para rf_para_rx_8188e[] = {
	{0, 0, false, 7},  /* for normal */
	{0, 10, false, 7}, /* for WL-CPT */
	{1, 0, true, 5},
	{1, 2, true, 5},
...
static const struct rtw_hw_reg rtw8188e_txagc[] = {
...
static int rtw8188e_power_on(struct rtw_dev *rtwdev)
{
	if (rtwdev->hal.cut_version < RTW_CHIP_VER_CUT_I) {
		rtw_err(rtwdev,
			"RTL8188E cut %u is unsupported; I-cut or newer is required\n",
...
static void rtw8188e_fill_tx_desc(struct rtw_dev *rtwdev,
				  struct rtw_tx_pkt_info *pkt_info,
				  struct sk_buff *skb)
{
	struct rtw8188e_tx_desc *tx_desc = (struct rtw8188e_tx_desc *)skb->data;

	tx_desc->w0 = le32_encode_bits(pkt_info->tx_pkt_size,
				       RTW8188E_TX_DESC_W0_TXPKTSIZE) |
		      le32_encode_bits(pkt_info->offset,
				       RTW8188E_TX_DESC_W0_OFFSET) |
		      le32_encode_bits(pkt_info->bmc, RTW8188E_TX_DESC_W0_BMC) |
		      le32_encode_bits(pkt_info->ls, RTW8188E_TX_DESC_W0_LS) |
		      le32_encode_bits(pkt_info->fs, RTW8188E_TX_DESC_W0_FS) |
		      le32_encode_bits(1, RTW8188E_TX_DESC_W0_OWN);
	tx_desc->w1 = le32_encode_bits(pkt_info->mac_id,
				       RTW8188E_TX_DESC_W1_MACID) |
		      le32_encode_bits(pkt_info->qsel,
				       RTW8188E_TX_DESC_W1_QSEL) |
		      le32_encode_bits(pkt_info->rate_id,
				       RTW8188E_TX_DESC_W1_RATE_ID) |
		      le32_encode_bits(pkt_info->nav_use_hdr,
				       RTW8188E_TX_DESC_W1_NAVUSEHDR) |
		      le32_encode_bits(pkt_info->sec_type,
				       RTW8188E_TX_DESC_W1_SEC_TYPE) |
		      le32_encode_bits(pkt_info->pkt_offset,
				       RTW8188E_TX_DESC_W1_PKT_OFFSET);
	tx_desc->w2 = le32_encode_bits(pkt_info->ampdu_en,
				       RTW8188E_TX_DESC_W2_AGG_EN) |
		      le32_encode_bits(!pkt_info->ampdu_en,
				       RTW8188E_TX_DESC_W2_AGG_BK) |
		      le32_encode_bits(pkt_info->report,
				       RTW8188E_TX_DESC_W2_SPE_RPT) |
		      le32_encode_bits(pkt_info->ampdu_density,
				       RTW8188E_TX_DESC_W2_AMPDU_DEN) |
		      le32_encode_bits(pkt_info->bt_null,
				       RTW8188E_TX_DESC_W2_BT_NULL);
	tx_desc->w3 = le32_encode_bits(pkt_info->seq,
				       RTW8188E_TX_DESC_W3_SEQ) |
		      le32_encode_bits(pkt_info->en_hwseq,
				       RTW8188E_TX_DESC_W3_EN_HWSEQ);
	tx_desc->w4 = le32_encode_bits(pkt_info->hw_ssn_sel,
				       RTW8188E_TX_DESC_W4_HW_SSN_SEL) |
		      le32_encode_bits(pkt_info->use_rate,
				       RTW8188E_TX_DESC_W4_USE_RATE) |
		      le32_encode_bits(pkt_info->dis_rate_fallback,
				       RTW8188E_TX_DESC_W4_DISDATAFB) |
		      le32_encode_bits(pkt_info->rts,
				       RTW8188E_TX_DESC_W4_USE_RTS) |
		      le32_encode_bits(pkt_info->rts,
				       RTW8188E_TX_DESC_W4_HW_RTS_EN) |
		      le32_encode_bits(rtwdev->hal.current_primary_channel_index,
				       RTW8188E_TX_DESC_W4_DATA_SC) |
		      le32_encode_bits(pkt_info->stbc,
				       RTW8188E_TX_DESC_W4_DATA_STBC) |
		      le32_encode_bits(pkt_info->bw != RTW_CHANNEL_WIDTH_20,
				       RTW8188E_TX_DESC_W4_DATA_BW);
	if (pkt_info->rts) {
		tx_desc->w4 |= le32_encode_bits(DESC_RATE24M,
						RTW8188E_TX_DESC_W4_RTS_RATE) |
			       le32_encode_bits(pkt_info->bw != RTW_CHANNEL_WIDTH_20,
						RTW8188E_TX_DESC_W4_RTS_BW) |
			       le32_encode_bits(rtwdev->hal.current_primary_channel_index,
						RTW8188E_TX_DESC_W4_RTS_SC);
	}
	tx_desc->w5 = le32_encode_bits(pkt_info->rate,
				       RTW8188E_TX_DESC_W5_DATA_RATE) |
		      le32_encode_bits(pkt_info->short_gi,
				       RTW8188E_TX_DESC_W5_DATA_SGI) |
		      le32_encode_bits(0x1f, RTW8188E_TX_DESC_W5_FB_LIMIT) |
		      le32_encode_bits(0xf, RTW8188E_TX_DESC_W5_RTS_FB_LIMIT);
	if (pkt_info->qsel == TX_DESC_QSEL_MGMT)
		tx_desc->w5 |=
			le32_encode_bits(1, RTW8188E_TX_DESC_W5_RETRY_LMT_EN) |
			le32_encode_bits(6, RTW8188E_TX_DESC_W5_RETRY_LMT);
	tx_desc->w6 = le32_encode_bits(pkt_info->ampdu_factor,
				       RTW8188E_TX_DESC_W6_MAX_AGG_NUM);
	tx_desc->w7 = le32_encode_bits(pkt_info->sn,
				       RTW8188E_TX_DESC_W7_SW_DEFINE);
}

static int rtw8188e_query_rx_desc(struct rtw_dev *rtwdev, void *rx_desc8,
				  struct rtw_rx_pkt_stat *pkt_stat)
{
	struct rtw8188e_rx_desc *rx_desc = rx_desc8;
	u32 enc_type, report_type;

	report_type = le32_get_bits(rx_desc->w3,
				    RTW8188E_RX_DESC_W3_RPT_SEL);
	pkt_stat->pkt_report_type = report_type;
	if (report_type != RTW8188E_RX_REPORT_NORMAL) {
		if (report_type == RTW8188E_RX_REPORT_TX_STATUS)
			pkt_stat->pkt_len = 8;
		else if (report_type == RTW8188E_RX_REPORT_RATE)
			pkt_stat->pkt_len = le32_to_cpu(rx_desc->w0) & 0x3ff;
		else
			pkt_stat->pkt_len = le32_get_bits(rx_desc->w0,
							  RTW8188E_RX_DESC_W0_PKT_LEN);
		return 0;
	}

	pkt_stat->pkt_len = le32_get_bits(rx_desc->w0,
					  RTW8188E_RX_DESC_W0_PKT_LEN);
	pkt_stat->crc_err = le32_get_bits(rx_desc->w0,
					  RTW8188E_RX_DESC_W0_CRC32);
	pkt_stat->icv_err = le32_get_bits(rx_desc->w0,
					  RTW8188E_RX_DESC_W0_ICV_ERR);
	pkt_stat->drv_info_sz = le32_get_bits(rx_desc->w0,
					      RTW8188E_RX_DESC_W0_DRV_INFO_SIZE);
	enc_type = le32_get_bits(rx_desc->w0,
				 RTW8188E_RX_DESC_W0_ENC_TYPE);
	pkt_stat->shift = le32_get_bits(rx_desc->w0,
					RTW8188E_RX_DESC_W0_SHIFT);
	pkt_stat->phy_status = le32_get_bits(rx_desc->w0,
					     RTW8188E_RX_DESC_W0_PHYST);
	pkt_stat->decrypted =
		!le32_get_bits(rx_desc->w0, RTW8188E_RX_DESC_W0_SWDEC) &&
		enc_type != RX_DESC_ENC_NONE;
	pkt_stat->cam_id = le32_get_bits(rx_desc->w1,
					 RTW8188E_RX_DESC_W1_MACID);
	pkt_stat->rate = le32_get_bits(rx_desc->w3,
				       RTW8188E_RX_DESC_W3_RATE);
	pkt_stat->bw = le32_get_bits(rx_desc->w3, RTW8188E_RX_DESC_W3_BW);
	pkt_stat->tsf_low = le32_get_bits(rx_desc->w5,
					  RTW8188E_RX_DESC_W5_TSFL);
 ...
 */
static const u32 rtw8188e_ofdm_swing_table[] = {
	0x0b40002d, /* 0,  -15.0dB */
	0x0c000030, /* 1,  -14.5dB */
	0x0cc00033, /* 2,  -14.0dB */
	0x0d800036, /* 3,  -13.5dB */
...
static const u32 rtw8188e_cck_pwr_regs[] = {
	0x0a22, 0x0a23, 0x0a24, 0x0a25, 0x0a26, 0x0a27, 0x0a28, 0x0a29,
};

static const u8 rtw8188e_cck_swing_table[][8] = {
...
static const u8 rtw8188e_cck_swing_table_ch14[][8] = {
...
#define RTW_OFDM_SWING_TABLE_SIZE	ARRAY_SIZE(rtw8188e_ofdm_swing_table)
#define RTW_CCK_SWING_TABLE_SIZE	ARRAY_SIZE(rtw8188e_cck_swing_table)

/* Power sequences, from the vendor's Hal8188EPwrSeq.h. Only the
 ...
 */
static const struct rtw_pwr_seq_cmd trans_carddis_to_cardemu_8188e[] = {
	{0x0086,
	 RTW_PWR_CUT_ALL_MSK,
	...
	{0xffff, RTW_PWR_CUT_ALL_MSK, RTW_PWR_INTF_ALL_MSK, 0,
	 RTW_PWR_CMD_END, 0, 0},
};

static const struct rtw_pwr_seq_cmd trans_cardemu_to_act_8188e[] = {
	{0x0006,
	 RTW_PWR_CUT_ALL_MSK,
	 RTW_PWR_INTF_ALL_MSK,
	 RTW_PWR_ADDR_MAC,
	...
	{0x0002,
	 ...
	 RTW_PWR_INTF_ALL_MSK,
	 RTW_PWR_ADDR_MAC,
	 RTW_PWR_CMD_WRITE, BIT(0) | BIT(1), 0},
	{0x0026,
	 RTW_PWR_CUT_ALL_MSK,
	 RTW_PWR_INTF_ALL_MSK,
	 RTW_PWR_ADDR_MAC,
...
static const struct rtw_pwr_seq_cmd trans_act_to_cardemu_8188e[] = {
	/* turn off RF */
	{0x001F,
	 RTW_PWR_CUT_ALL_MSK,
	 RTW_PWR_INTF_ALL_MSK,
...
static const struct rtw_pwr_seq_cmd trans_cardemu_to_carddis_8188e[] = {
	{0x0026,
	 RTW_PWR_CUT_ALL_MSK,
	 RTW_PWR_INTF_ALL_MSK,
	 RTW_PWR_ADDR_MAC,
...
static const struct rtw_pwr_seq_cmd * const card_enable_flow_8188e[] = {
	trans_carddis_to_cardemu_8188e,
	trans_cardemu_to_act_8188e,
	NULL
};

static const struct rtw_pwr_seq_cmd * const card_disable_flow_8188e[] = {
	trans_act_to_cardemu_8188e,
	trans_cardemu_to_carddis_8188e,
	NULL
};

/* HPQ/NPQ/LPQ page counts from NORMAL_PAGE_NUM_{HPQ,NPQ,LPQ}_8188E.
 * Only entry 0 (SDIO) is reachable for this chip, the rest are copies so
 * the core's per-bus indexing stays in range.
 */
static const struct rtw_page_table page_table_8188e[] = {
	{0, 0, 9, 0, 1},
	{0, 0, 9, 0, 1},
	{0, 0, 9, 0, 1},
	{0, 0, 9, 0, 1},
 ...
 */
static const struct rtw_rqpn rqpn_table_8188e[] = {
...
static const struct rtw_prioq_addrs prioq_addrs_8188e = {
...
static const struct rtw_hw_reg dig_8188e[] = {
	[0] = { .addr = REG_OFDM0_XAAGC1, .mask = 0x7f },
	[1] = { .addr = REG_OFDM0_XAAGC1, .mask = 0x7f },
};

static const struct rtw_hw_reg dig_cck_8188e[] = {
	[0] = { .addr = 0xa0c, .mask = 0x3f00 },
};

static const struct rtw_rf_sipi_addr rf_sipi_addr_8188e[] = {
...
static int rtw8188e_read_efuse(struct rtw_dev *rtwdev, u8 *log_map)
{
	struct rtw_efuse *efuse = &rtwdev->efuse;
	struct rtw8188e_efuse *map;
	u8 pa_lna_type;

	map = (struct rtw8188e_efuse *)log_map;

	efuse->rfe_option = map->rfe_option == 0xff ? 0 :
			    map->rfe_option & 0x1;
	efuse->rf_board_option = map->rf_board_option;
	efuse->crystal_cap = map->xtal_k;
	pa_lna_type = map->rfe_option >> 2 & 0x3;
	efuse->ext_pa_2g = pa_lna_type == 0 || pa_lna_type == 1;
	efuse->ext_lna_2g = pa_lna_type == 0 || pa_lna_type == 2;
	efuse->channel_plan = map->channel_plan;
	efuse->country_code[0] = map->country_code[0];
	efuse->country_code[1] = map->country_code[1];
	efuse->bt_setting = map->rf_bt_setting;
	efuse->regd = map->rf_board_option & 0x7;
	efuse->thermal_meter[RF_PATH_A] = map->thermal_meter == 0xff ?
						  0x18 : map->thermal_meter;
	efuse->thermal_meter_k = efuse->thermal_meter[RF_PATH_A];
	memcpy(efuse->txpwr_idx_table[RF_PATH_A].pwr_idx_2g.cck_base,
	       map->txpwr_idx.cck_base, sizeof(map->txpwr_idx.cck_base));
	memcpy(efuse->txpwr_idx_table[RF_PATH_A].pwr_idx_2g.bw40_base,
	       map->txpwr_idx.bw40_base, sizeof(map->txpwr_idx.bw40_base));
	efuse->txpwr_idx_table[RF_PATH_A].pwr_idx_2g.ht_1s_diff =
		map->txpwr_idx.ht_1s_diff;

	switch (rtw_hci_type(rtwdev)) {
	case RTW_HCI_TYPE_SDIO:
		ether_addr_copy(efuse->addr, map->mac_addr);
		break;
	default:
		/* unsupported now */
		return -EOPNOTSUPP;
	...
	/* RTL8188E is a WiFi-only part, there is no Bluetooth to coexist
...
static void rtw8188e_cfg_ldo25(struct rtw_dev *rtwdev, bool enable)
{
	u8 ldo_pwr;
...
static void rtw8188e_efuse_grant(struct rtw_dev *rtwdev, bool on)
{
	if (on) {
...
static int rtw8188e_mac_init(struct rtw_dev *rtwdev)
{
	...
	rtw_write8(rtwdev, 0x463, 0x05);
	rtw_write16_set(rtwdev, REG_TXDMA_OFFSET_CHK, BIT_DROP_DATA_EN);

	return 0;
}

static int rtw8188e_mac_postinit(struct rtw_dev *rtwdev)
{
	return 0;
}

static void rtw8188e_pwrtrack_init(struct rtw_dev *rtwdev)
{
	...
	swing = rtw_read32_mask(rtwdev, REG_OFDM0_XA_TX_IQ_IMBALANCE,
				GENMASK(31, 22));
	for (i = 0; i < RTW_OFDM_SWING_TABLE_SIZE; i++) {
		if (swing == FIELD_GET(GENMASK(31, 22),
				       rtw8188e_ofdm_swing_table[i])) {
			dm_info->default_ofdm_index = i;
			break;
		}
	}

	swing = rtw_read8(rtwdev, rtw8188e_cck_pwr_regs[0]);
	for (i = 0; i < RTW_CCK_SWING_TABLE_SIZE; i++) {
		if (swing == rtw8188e_cck_swing_table[i][0]) {
			dm_info->default_cck_index = i;
			break;
		}
	}
...
static void rtw8188e_phy_set_param(struct rtw_dev *rtwdev)
{
	u8 xtal_cap = rtwdev->efuse.crystal_cap & 0x3F;

	/* power on BB/RF domain, vendor PHY_BBConfig8188E() */
	...
	rtw_write32_mask(rtwdev, REG_AFE_XTAL_CTRL, BIT_MASK_XTAL_8188E,
			 xtal_cap | (xtal_cap << 6));
	...
	rtw_write8_set(rtwdev, REG_FWHW_TXQ_CTRL, BIT_EN_AMPDU_RTY_NEW);
	...
	/* vendor BBTurnOnBlock_8188E() */
	rtw_write32_set(rtwdev, REG_FPGA0_RFMOD, BIT_CCKEN | BIT_OFDMEN);

	rtw_phy_init(rtwdev);

	/* Unlike 8703B/8723D/8710B, the 8188E CCK AGC report always uses a
	 * 3 bit LNA index (vendor phydm_cck_new_agc_chk() has no 8188E
	 * case, and phydm_phy_sts_n_parsing() only extends the index for
	 * those other chips).
	 */
	rtwdev->dm_info.rx_cck_agc_report_type = 0;

	rtw8188e_pwrtrack_init(rtwdev);
}

static void rtw8188e_set_channel_rf(struct rtw_dev *rtwdev, u8 channel, u8 bw)
{
	u32 rf_cfgch;

	rf_cfgch = rtw_read_rf(rtwdev, RF_PATH_A, RF_CFGCH, RFREG_MASK);
	rf_cfgch &= ~GENMASK(9, 0);
	rf_cfgch |= channel & GENMASK(9, 0);

	/* vendor PHY_RF6052SetBandwidth8188E() */
...
static void rtw8188e_spur_calibration(struct rtw_dev *rtwdev, u8 channel,
				      u8 bw)
{
	bool enable = (bw == RTW_CHANNEL_WIDTH_20 && channel >= 13) ||
		      (bw == RTW_CHANNEL_WIDTH_40 && channel == 11);

	rtw_write32_mask(rtwdev, REG_OFDM0_RXDSP, BIT(9), enable);
	if (!enable)
		return;

	rtw_write32_mask(rtwdev, REG_OFDM1_INTFDET, GENMASK(8, 6), 0x2);
	rtw_write32_mask(rtwdev, REG_OFDM0_RXDSP, GENMASK(28, 24), 0x1f);
}

static void rtw8188e_set_channel_bb(struct rtw_dev *rtwdev, u8 bw,
				    u8 primary_ch_idx)
{
	switch (bw) {
	case RTW_CHANNEL_WIDTH_20:
	...
	case RTW_CHANNEL_WIDTH_40:
		...
		rtw_write32_mask(rtwdev, REG_OFDM_FA_RSTD_11N, GENMASK(11, 10),
				 primary_ch_idx);
...
static void rtw8188e_set_channel(struct rtw_dev *rtwdev, u8 channel, u8 bw,
				 u8 primary_chan_idx)
{
	rtw8188e_set_channel_rf(rtwdev, channel, bw);
	rtw_set_channel_mac(rtwdev, channel, bw, primary_chan_idx);
	rtw8188e_set_channel_bb(rtwdev, bw, primary_chan_idx);
	rtw8188e_spur_calibration(rtwdev, channel, bw);
}

/* vendor phydm_cck_rssi_8188e() */
static s8 get_cck_rx_pwr(struct rtw_dev *rtwdev, u8 lna_idx, u8 vga_idx)
{
	static const s8 lna_gain[] = { 17, -1, -13, 0, -32, -35, -38, -36 };

	if (lna_idx >= ARRAY_SIZE(lna_gain))
		return -120;

	return lna_gain[lna_idx] - 2 * vga_idx;
}

static void query_phy_status_cck(struct rtw_dev *rtwdev, u8 *phy_raw,
				 struct rtw_rx_pkt_stat *pkt_stat)
{
	struct phy_status_8188e *phy_status = (struct phy_status_8188e *)phy_raw;
...
static void rtw8188e_false_alarm_statistics(struct rtw_dev *rtwdev)
{
	struct rtw_dm_info *dm_info = &rtwdev->dm_info;
	u32 cck_fa_cnt;
	u32 ofdm_fa_cnt;
...
static void rtw8188e_lck(struct rtw_dev *rtwdev)
{
	u32 lc_cal;
	u8 val_ctx, rf_val;
	int ret;
...
/* IQK, ported from the vendor's phy_iq_calibrate_8188e() and friends in
 * hal/phydm/halrf/rtl8188e/halrf_8188e.c. RTL8188E is 1T1R, so only
 * path A is calibrated; the vendor's path B code is compiled out there.
 */
#define ADDA_ON_VAL_8188E 0x03c00014

static const u32 iqk_adda_regs_8188e[RTW8188E_IQK_ADDA_REG_NUM] = {
...
static const u32 iqk_mac8_regs_8188e[RTW8188E_IQK_MAC8_REG_NUM] = {
	REG_TXPAUSE, REG_BCN_CTRL, REG_BCN_CTRL_CLINT0,
};

static const u32 iqk_mac32_regs_8188e[RTW8188E_IQK_MAC32_REG_NUM] = {
	REG_GPIO_MUXCFG,
};

static const u32 iqk_bb_regs_8188e[RTW8188E_IQK_BB_REG_NUM] = {
...
static void rtw8188e_iqk_backup_regs(struct rtw_dev *rtwdev,
				     struct rtw8188e_iqk_backup_regs *backup)
{
	int i;

	for (i = 0; i < RTW8188E_IQK_ADDA_REG_NUM; i++)
		backup->adda[i] = rtw_read32(rtwdev, iqk_adda_regs_8188e[i]);
	for (i = 0; i < RTW8188E_IQK_MAC8_REG_NUM; i++)
		backup->mac8[i] = rtw_read8(rtwdev, iqk_mac8_regs_8188e[i]);
	for (i = 0; i < RTW8188E_IQK_MAC32_REG_NUM; i++)
		backup->mac32[i] = rtw_read32(rtwdev, iqk_mac32_regs_8188e[i]);
	for (i = 0; i < RTW8188E_IQK_BB_REG_NUM; i++)
		backup->bb[i] = rtw_read32(rtwdev, iqk_bb_regs_8188e[i]);
...
static void rtw8188e_iqk_restore_regs(struct rtw_dev *rtwdev,
				      const struct rtw8188e_iqk_backup_regs *backup)
{
	int i;
	...
	for (i = 0; i < RTW8188E_IQK_ADDA_REG_NUM; i++)
		rtw_write32(rtwdev, iqk_adda_regs_8188e[i], backup->adda[i]);
	for (i = 0; i < RTW8188E_IQK_MAC8_REG_NUM; i++)
		rtw_write8(rtwdev, iqk_mac8_regs_8188e[i], backup->mac8[i]);
	for (i = 0; i < RTW8188E_IQK_MAC32_REG_NUM; i++)
		rtw_write32(rtwdev, iqk_mac32_regs_8188e[i], backup->mac32[i]);
	for (i = 0; i < RTW8188E_IQK_BB_REG_NUM; i++)
		rtw_write32(rtwdev, iqk_bb_regs_8188e[i], backup->bb[i]);
...
static void rtw8188e_iqk_path_adda_on(struct rtw_dev *rtwdev)
{
	int i;

	for (i = 0; i < RTW8188E_IQK_ADDA_REG_NUM; i++)
		rtw_write32(rtwdev, iqk_adda_regs_8188e[i], ADDA_ON_VAL_8188E);
}

static void rtw8188e_iqk_config_mac(struct rtw_dev *rtwdev)
{
	rtw_write8(rtwdev, REG_TXPAUSE, 0xff);
}

static void rtw8188e_iqk_one_shot(struct rtw_dev *rtwdev)
{
	rtw_write32(rtwdev, REG_IQK_AGC_PTS, 0xf9000000);
	rtw_write32(rtwdev, REG_IQK_AGC_PTS, 0xf8000000);

	msleep(RTW8188E_IQK_DELAY_MS);
...
static bool rtw8188e_iqk_tx_ok(struct rtw_dev *rtwdev)
{
...
static bool rtw8188e_iqk_rx_ok(struct rtw_dev *rtwdev)
{
	u32 reg_eac, reg_ea4;
 ...
 */
static void rtw8188e_iqk_rf_setting(struct rtw_dev *rtwdev, u32 rck_os,
				    u32 txpa_g2, u32 pad)
{
	rtw_write32_mask(rtwdev, REG_FPGA0_IQK, MASKH3BYTES, 0x000000);
...
/* vendor phy_path_a_iqk_8188e(): TX IQK only */
static bool rtw8188e_iqk_tx_path(struct rtw_dev *rtwdev)
{
	rtw_dbg(rtwdev, RTW_DBG_RFK, "[IQK] path A TX IQK\n");

	rtw8188e_iqk_rf_setting(rtwdev, 0x20000, 0x07ff7, 0x5102a);
	...
	rtw8188e_iqk_one_shot(rtwdev);

	return rtw8188e_iqk_tx_ok(rtwdev);
}

/* vendor phy_path_a_rx_iqk_8188e(): re-runs TX IQK to get TXIMR, then RX */
static bool rtw8188e_iqk_rx_path(struct rtw_dev *rtwdev, u32 lok)
{
	...
	/* 1 Get TXIMR setting */
	rtw8188e_iqk_rf_setting(rtwdev, 0x30000, 0xf1173, 0x5102a);
	...
	/* 1 RX IQK */
	rtw8188e_iqk_rf_setting(rtwdev, 0x30000, 0xf7ff2, 0x51000);
	...
	return rtw8188e_iqk_rx_ok(rtwdev);
}

static void rtw8188e_iqk_one_round(struct rtw_dev *rtwdev,
				   s32 result[][IQK_NR], u8 t)
{
	...
	rtw8188e_iqk_path_adda_on(rtwdev);
	...
	rtw8188e_iqk_config_mac(rtwdev);

	rtw_write32_mask(rtwdev, REG_FPGA0_IQK, MASKH3BYTES, 0x808000);
	rtw_write32(rtwdev, REG_TX_IQK, 0x01007c00);
	rtw_write32(rtwdev, REG_RX_IQK, 0x01004800);

	for (i = 0; i < RTW8188E_IQK_RETRY; i++) {
		if (!rtw8188e_iqk_tx_path(rtwdev))
			continue;
	...
	for (i = 0; i < RTW8188E_IQK_RETRY; i++) {
		if (!rtw8188e_iqk_rx_path(rtwdev, lok))
			continue;
...
/* vendor phy_simularity_compare_8188e(), reduced to the 1T1R case */
static bool rtw8188e_iqk_similarity_cmp(struct rtw_dev *rtwdev,
					s32 result[][IQK_NR], u8 c1, u8 c2)
{
	...
	for (i = 0; i < IQK_NR; i++) {
		...
		diff = abs(tmp1 - tmp2);
		if (diff <= RTW8188E_IQK_MAX_TOLERANCE)
			continue;
...
/* vendor _phy_path_a_fill_iqk_matrix8188e() */
static void rtw8188e_iqk_fill_matrix(struct rtw_dev *rtwdev, const s32 *result,
				     bool tx_only)
{
...
static void rtw8188e_iqk(struct rtw_dev *rtwdev)
{
	struct rtw_dm_info *dm_info = &rtwdev->dm_info;
	struct rtw8188e_iqk_backup_regs backup;
	...
	rtw8188e_iqk_backup_regs(rtwdev, &backup);

	for (i = IQK_ROUND_0; i <= IQK_ROUND_2; i++) {
		rtw8188e_iqk_one_round(rtwdev, result, i);

		if (i > IQK_ROUND_0)
			rtw8188e_iqk_restore_regs(rtwdev, &backup);

		for (j = IQK_ROUND_0; j < i; j++) {
			if (rtw8188e_iqk_similarity_cmp(rtwdev, result, j, i)) {
				final_candidate = j;
				goto iqk_done;
			}
		}
...
iqk_done:
	if (result[final_candidate][IQK_TX_X] != 0)
		rtw8188e_iqk_fill_matrix(rtwdev, result[final_candidate],
...
static void rtw8188e_phy_calibration(struct rtw_dev *rtwdev)
{
	rtw8188e_iqk(rtwdev);
	rtw8188e_lck(rtwdev);
}

static void rtw8188e_set_tx_power_index_by_rate(struct rtw_dev *rtwdev,
						u8 path, u8 rs)
{
	...
	for (j = 0; j < rtw_rate_size[rs]; j++) {
		...
		if (rate >= ARRAY_SIZE(rtw8188e_txagc)) {
			rtw_warn(rtwdev, "rate 0x%x isn't supported\n", rate);
			continue;
		}
		txagc = &rtw8188e_txagc[rate];
		if (!txagc->addr) {
...
static void rtw8188e_set_tx_power_index(struct rtw_dev *rtwdev)
{
	struct rtw_hal *hal = &rtwdev->hal;
	int rs, path;
	...
	for (path = 0; path < hal->rf_path_num; path++)
		for (rs = 0; rs <= RTW_RATE_SECTION_HT_1S; rs++)
			rtw8188e_set_tx_power_index_by_rate(rtwdev, path, rs);
}

static void rtw8188e_pwrtrack_set_ofdm_pwr(struct rtw_dev *rtwdev, s8 swing_idx,
					   s8 txagc_idx)
{
	struct rtw_dm_info *dm_info = &rtwdev->dm_info;
	s32 ele_a, ele_c, ele_d;
	s32 x, y;
	u32 swing;
	...
	swing = rtw8188e_ofdm_swing_table[swing_idx];
	if (!dm_info->iqk.done) {
		rtw_write32(rtwdev, REG_OFDM0_XA_TX_IQ_IMBALANCE, swing);
		rtw_write32_mask(rtwdev, REG_OFDM0_XC_TX_AFE, MASKH4BITS, 0);
		rtw_write32_mask(rtwdev, REG_OFDM0_ECCA_THRES, BIT(24), 0);
		return;
	}

	ele_d = FIELD_GET(GENMASK(31, 22), swing);
	x = iqk_to_s32(dm_info->iqk.result.s1_x);
	y = iqk_to_s32(dm_info->iqk.result.s1_y);
	ele_a = (x * ele_d) >> 8;
	ele_c = (y * ele_d) >> 8;
	swing = (ele_d << 22) | ((ele_c & 0x3f) << 16) |
		(ele_a & 0x3ff);

	rtw_write32(rtwdev, REG_OFDM0_XA_TX_IQ_IMBALANCE, swing);
	rtw_write32_mask(rtwdev, REG_OFDM0_XC_TX_AFE, MASKH4BITS,
			 (ele_c & 0x3c0) >> 6);
	rtw_write32_mask(rtwdev, REG_OFDM0_ECCA_THRES, BIT(24),
			 ((x * ele_d) >> 7) & 0x1);
}

static void rtw8188e_pwrtrack_set_cck_pwr(struct rtw_dev *rtwdev, s8 swing_idx,
					  s8 txagc_idx)
{
	struct rtw_dm_info *dm_info = &rtwdev->dm_info;
	const u8 (*swing_table)[8];
	int i;
	...
	if (rtwdev->hal.current_channel == 14)
		swing_table = rtw8188e_cck_swing_table_ch14;
	else
		swing_table = rtw8188e_cck_swing_table;

	BUILD_BUG_ON(ARRAY_SIZE(rtw8188e_cck_pwr_regs) != 8);

	for (i = 0; i < ARRAY_SIZE(rtw8188e_cck_pwr_regs); i++)
		rtw_write8(rtwdev, rtw8188e_cck_pwr_regs[i],
			   swing_table[swing_idx][i]);
}

static u8 rtw8188e_pwrtrack_get_limit_ofdm(struct rtw_dev *rtwdev)
{
...
static void rtw8188e_pwrtrack_set(struct rtw_dev *rtwdev)
{
	struct rtw_dm_info *dm_info = &rtwdev->dm_info;
	s8 final_ofdm_swing_index;
	s8 final_cck_swing_index;
	u8 pwr_tracking_limit_ofdm;
	u8 pwr_tracking_limit_cck = 28; /* -2dB */

	pwr_tracking_limit_ofdm = rtw8188e_pwrtrack_get_limit_ofdm(rtwdev);
	...
	if (final_ofdm_swing_index > pwr_tracking_limit_ofdm)
		rtw8188e_pwrtrack_set_ofdm_pwr(rtwdev, pwr_tracking_limit_ofdm,
					       final_ofdm_swing_index -
					       pwr_tracking_limit_ofdm);
	else if (final_ofdm_swing_index < 0)
		rtw8188e_pwrtrack_set_ofdm_pwr(rtwdev, 0,
					       final_ofdm_swing_index);
	else
		rtw8188e_pwrtrack_set_ofdm_pwr(rtwdev, final_ofdm_swing_index, 0);

	if (final_cck_swing_index > pwr_tracking_limit_cck)
		rtw8188e_pwrtrack_set_cck_pwr(rtwdev, pwr_tracking_limit_cck,
					      final_cck_swing_index -
					      pwr_tracking_limit_cck);
	else if (final_cck_swing_index < 0)
		rtw8188e_pwrtrack_set_cck_pwr(rtwdev, 0, final_cck_swing_index);
	else
		rtw8188e_pwrtrack_set_cck_pwr(rtwdev, final_cck_swing_index, 0);

	rtw_phy_set_tx_power_level(rtwdev, rtwdev->hal.current_channel);
}

static void rtw8188e_phy_pwrtrack(struct rtw_dev *rtwdev)
{
	struct rtw_dm_info *dm_info = &rtwdev->dm_info;
	...
	dm_info->delta_power_index_last[RF_PATH_A] =
		dm_info->delta_power_index[RF_PATH_A];
	rtw8188e_pwrtrack_set(rtwdev);

out:
	dm_info->pwr_trk_triggered = false;
}

static void rtw8188e_pwr_track(struct rtw_dev *rtwdev)
{
	struct rtw_efuse *efuse = &rtwdev->efuse;
	struct rtw_dm_info *dm_info = &rtwdev->dm_info;
	...
	rtw8188e_phy_pwrtrack(rtwdev);
}

static void rtw8188e_fill_txdesc_checksum(struct rtw_dev *rtwdev,
					  struct rtw_tx_pkt_info *pkt_info,
					  u8 *txdesc)
{
	struct rtw8188e_tx_desc *tx_desc = (struct rtw8188e_tx_desc *)txdesc;
	const u8 *data = txdesc;
	u16 checksum = 0;
	int words = 32 / 2;

	le32p_replace_bits(&tx_desc->w7, 0, RTW8188E_TX_DESC_W7_CHECKSUM);
	...
	le32p_replace_bits(&tx_desc->w7, checksum,
			   RTW8188E_TX_DESC_W7_CHECKSUM);
}

static const struct rtw_chip_ops rtw8188e_ops = {
	.power_on		= rtw8188e_power_on,
	.power_off		= rtw_power_off,
	.mac_init		= rtw8188e_mac_init,
	.mac_postinit		= rtw8188e_mac_postinit,
	.dump_fw_crash		= NULL,
	.shutdown		= NULL,
	.read_efuse		= rtw8188e_read_efuse,
	.phy_set_param		= rtw8188e_phy_set_param,
	.set_channel		= rtw8188e_set_channel,
	.query_phy_status	= query_phy_status,
	.query_rx_desc		= rtw8188e_query_rx_desc,
	.read_rf		= rtw_phy_read_rf_sipi,
	.write_rf		= rtw_phy_write_rf_reg_sipi,
	.set_tx_power_index	= rtw8188e_set_tx_power_index,
	.set_antenna		= NULL,
	.cfg_ldo25		= rtw8188e_cfg_ldo25,
	.efuse_grant		= rtw8188e_efuse_grant,
	.set_ampdu_factor	= NULL,
	.false_alarm_statistics	= rtw8188e_false_alarm_statistics,
	.phy_calibration	= rtw8188e_phy_calibration,
	.dpk_track		= NULL,
	/* Like 8703B, this chip generation has no REG_CSRATIO, so there
	 * is no CCK PD default to read and nothing to set.
	 */
	.cck_pd_set		= NULL,
	.pwr_track		= rtw8188e_pwr_track,
	.config_bfee		= NULL,
	.set_gid_table		= NULL,
	.cfg_csi_rate		= NULL,
	...
	.fill_tx_desc		= rtw8188e_fill_tx_desc,
	.fill_txdesc_checksum	= rtw8188e_fill_txdesc_checksum,
...
static const struct rtw_rfe_def rtw8188e_rfe_defs[] = {
	[0] = { .phy_pg_tbl = &rtw8188e_bb_pg_tbl,
		.txpwr_lmt_tbl = &rtw8188e_txpwr_lmt_tbl, },
	[1] = { .phy_pg_tbl = &rtw8188e_bb_pg_tbl,
		.txpwr_lmt_tbl = &rtw8188e_txpwr_lmt_tbl, },
};

const struct rtw_chip_info rtw8188e_hw_spec = {
	.ops = &rtw8188e_ops,
	.id = RTW_CHIP_TYPE_8188E,

	.fw_name = "rtw88/rtw8188e_s_fw.bin",
	...
	.log_efuse_size = 512,
	.ptct_efuse_size = 18,
	/* TX 32K, RX 16K, see the comment above PAGE_SIZE_TX_8188E in the
	 * vendor driver's include/rtl8188e_hal.h.
	 */
	.txff_size = 32768,
	.rxff_size = 16384,
	.rsvd_drv_pg_num = 8,
	...
	.sdio_oqt_free_addr = 0x25,
	.sdio_rx_agg_align = 128,
	.csi_buf_pg_num = 0,
	.dig_min = 0x20,
	.txgi_factor = 1,
	...
	.sys_func_en = 0xFD,
	.pwr_on_seq = card_enable_flow_8188e,
	.pwr_off_seq = card_disable_flow_8188e,
	.rqpn_table = rqpn_table_8188e,
	.prioq_addrs = &prioq_addrs_8188e,
	.page_table = page_table_8188e,
	/* used only in pci.c, not needed for SDIO devices */
	.intf_table = NULL,

	.dig = dig_8188e,
	.dig_cck = dig_cck_8188e,

	.rf_sipi_addr = {0x840, 0x844},
	.rf_sipi_read_addr = rf_sipi_addr_8188e,
	.fix_rf_phy_num = 1,
	.ltecoex_addr = NULL,

	.mac_tbl = &rtw8188e_mac_tbl,
	.agc_tbl = &rtw8188e_agc_tbl,
	.bb_tbl = &rtw8188e_bb_tbl,
	.rf_tbl = {&rtw8188e_rf_a_tbl},

	.rfe_defs = rtw8188e_rfe_defs,
	.rfe_defs_size = ARRAY_SIZE(rtw8188e_rfe_defs),
	...
	.ant_isolation = 15,
	.rssi_tolerance = 2,
	.bt_rssi_step = bt_rssi_step_8188e,
	.wl_rssi_step = wl_rssi_step_8188e,
	.wl_rf_para_tx = rf_para_tx_8188e,
	.wl_rf_para_rx = rf_para_rx_8188e,
	.wl_rf_para_num = ARRAY_SIZE(rf_para_tx_8188e),
	.afh_5g = afh_5g_8188e,
	.afh_5g_num = ARRAY_SIZE(afh_5g_8188e),
};
EXPORT_SYMBOL(rtw8188e_hw_spec);

MODULE_FIRMWARE("rtw88/rtw8188e_s_fw.bin");

MODULE_AUTHOR("Realtek Corporation");
MODULE_AUTHOR("Jernej Skrabec <jernej.skrabec@gmail.com>");
MODULE_DESCRIPTION("Realtek 802.11n wireless 8188e driver");
