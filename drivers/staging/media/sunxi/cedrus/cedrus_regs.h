...
#define VE_DEC_VC1_PICQP_DQDBEDGE(x)		SHIFT_AND_MASK_BITS(x, 15, 14)
...
#define VE_DEC_VC1_PICICBAK0			(VE_ENGINE_DEC_VC1 + 0x68)
#define VE_DEC_VC1_PICICBAK1			(VE_ENGINE_DEC_VC1 + 0x6c)
